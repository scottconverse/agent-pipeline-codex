...
**Current release: v0.5.2** (Codex Desktop App split). [CHANGELOG](CHANGELOG.md) · [User Manual](USER-MANUAL.md) · [Architecture](ARCHITECTURE.md) · [Landing page](https://scottconverse.github.io/agent-pipeline-codex/) · [Discussions](https://github.com/scottconverse/agent-pipeline-codex/discussions)
